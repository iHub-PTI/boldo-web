...
const DetailPanel = (props: Props) => {
  const { orderId = '', small = false } = props
      ...
      {loadingOrder ? (
        ...
        orderStudy && (
          <div className='flex flex-col space-y-6'>
            {/* profile and date */}
            <div className={`flex flex-row justify-between ${smallClass}`}>
              {/* profile */}
              <DoctorProfile doctor={orderStudy?.doctor} organization={orderStudy?.organization} small={small} />
              {/* date section */}
