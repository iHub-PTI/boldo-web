  ...
  return (
    <div className='flex flex-col space-y-8 p-5'>
      ...
      <div className='flex flex-row justify-between'>
        ...
        <DoctorProfile
          doctor={
            OrderImported?.doctor as unknown as Omit<iHub.Doctor, 'specializations'> & {
              specializations: iHub.Specialization[]
            }
          }
          organization={OrderImported?.organization as Boldo.OrganizationInOrderStudy}
        />
        {/* date section */}
      ...
      <div className='flex flex-col space-y-6'>
        ...
        <div className='flex flex-col space-y-5 px-4'>
          ...
          <div className='flex flex-col space-y-1'>
            ...
            {OrderImported?.studiesCodes?.map((code, idx) => (
              <li key={idx} className='not-italic font-normal text-sm leading-4 text-gray-700'>
                {code?.display ?? ''}
              </li>
            ))}
          </div>
