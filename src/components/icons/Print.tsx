...
const Print = ({ iconColor="#ABAFB6", bgColor="#F7F4F4", height="4.5rem", width="4.5rem", fromVirtual }) => {
  return (
    fromVirtual 
      ? <Tooltip title={<h1 style={{ fontSize: 14 }}>Impresión de recetas</h1>} placement="left" leaveDelay={100} >
