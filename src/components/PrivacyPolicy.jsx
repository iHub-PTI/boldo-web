  ...
  return (
    <div className={classes.root}>
      ...
      <Container component="main" className={classes.main} maxWidth="md">
        ...
        <Typography variant="body1" className={classes.separator}>Información que usted nos proporciona: cualquier información que nos proporcione al usar Boldo, incluso cuando incluye información en un formulario web, incorpora o actualiza la información de su cuenta, participa en discusiones, charlas o resoluciones de controversias en la comunidad, o cuando se comunica con nosotros para tratar acerca de los servicios Boldo: Información de contacto, como su nombre y apellido, sexo, fecha de nacimiento, número de documento de indentidad, tipo de documento, dirección, número de teléfono, correo electrónico y otra información similar; información médica, como diagnósticos, recetas, medicamentos que consume, le son recetados y/o dispensados, indicaciones médicas, etc.</Typography>
        <Typography variant="body1" className={classes.separator}>También podemos recopilar información de usted o acerca de usted de otras fuentes, como por ejemplo, a través de comunicaciones con nosotros, lo que incluye a nuestro equipo de soporte técnico, sus resultados cuando responde una encuesta y sus interacciones con los miembros del equipo de boldo u otras empresas (sujeto a sus políticas de privacidad y a las leyes vigentes). Además, para fines de calidad y capacitación o por su propia protección, Boldo puede controlar o grabar las conversaciones telefónicas que tengamos con usted o con cualquier persona que actúe en su nomnbre. Al comunicarse con el soporte técnico de Boldo, usted reconoce que la comunicación podría ser escuchada, controlada o grabada sin notificación o advertencia.</Typography>
