                                ...
                                return (
                                    <section style={{ backgroundColor: '#F7FAFC' }} className="flex-shrink-0 rounded-full mb-3">
                                        <Grid className="p-2" container wrap="nowrap">
                                            ...
                                            <Typography className='w-40 hover:w-auto hover:break-all' variant='subtitle1' title={book.title} noWrap style={{ paddingTop: '2px', paddingLeft: '10px', textAlign: 'left', color: '#6B7280' }}>
                                                {book.title}
                                            </Typography>
                                            <button
