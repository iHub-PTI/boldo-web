...
const soepPlaceholder = {
  'Subjetivo': 'Los datos referidos por el paciente, son datos descriptivos: AREA (Antecedentes Remotos de la Enfermedad Actual), AEA (Antecedentes de la Enfermedad Actual).',
