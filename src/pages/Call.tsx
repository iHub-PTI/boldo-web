    ...
    return (
      <div>
        <FloatingMenu slideSpeed={500} isOpen={isOpen} spacing={8} direction={Directions.Up}>
          ...
          <ChildButton
            icon={
              <Tooltip title={<h1 style={{ fontSize: 14 }}>Estudios</h1>} placement="left" leaveDelay={100}>
          ...
          <ChildButton
            icon={
              <Tooltip title={<h1 style={{ fontSize: 14 }}>Recetas</h1>} placement="left" leaveDelay={100}>
          ...
          <ChildButton 
            icon={
              <Tooltip title={<h1 style={{ fontSize: 14 }}>Notas médicas</h1>} placement="left" leaveDelay={100}>
                <RecordIcon />
              </Tooltip>
            } 
            background='#323030' 
          ...
          <ChildButton
            icon={
              <Tooltip title={<h1 style={{ fontSize: 14 }}>Perfil del paciente</h1>} placement="left" leaveDelay={100}>
